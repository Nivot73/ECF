...
class __TwigTemplate_ad3e624174f42207cf508c0e47d84400 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous etes connecter comme {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Deconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\laragon\\www\\ECF\\templates\\security\\login.html.twig");
    }
}
